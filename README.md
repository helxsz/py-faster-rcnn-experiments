...
python tools/train_faster_rcnn_alt_opt.py --gpu 0 --net_name VGG_CNN_M_1024_CAR_9 --weights data/imagenet_models/VGG_CNN_M_1024.v2.caffemodel --imdb mycar1_train --cfg experiments/cfgs/faster_rcnn_alt_opt.yml

python tools/train_faster_rcnn_alt_opt.py --gpu 0 --net_name VGG_CNN_M_1024_CAR_91 --weights data/imagenet_models/VGG16.v2.caffemodel --imdb mycar1_train --cfg experiments/cfgs/faster_rcnn_alt_opt.yml
